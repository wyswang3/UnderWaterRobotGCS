            ...
            while True:
                ...
                if now >= next_print_ns:
                    ...
                    snap = TuiStatusSnapshot(
                        ...
                        imu_online=int(st.imu_online),
                        dvl_online=int(st.dvl_online),
                        imu_reconnecting=int(st.imu_reconnecting),
                        dvl_reconnecting=int(st.dvl_reconnecting),
                        imu_mismatch=int(st.imu_mismatch),
                        dvl_mismatch=int(st.dvl_mismatch),
                        ...
                        command_fault_code=st.command_fault_code,
